...
public class TemplateWriteContext extends WriteContext{
     ...
     * @see TemplatePlaceholderPattern#SINGLE_REFERENCE_TEMPLATE_PLACEHOLDER
     */
    private HashBasedTable<Integer,String,CellAddress> singleReferenceData = HashBasedTable.create();

    /**
     * 循环引用索引
     * @see TemplatePlaceholderPattern#CIRCLE_REFERENCE_TEMPLATE_PLACEHOLDER
     */
     ...
     * 计算占位符
     * <p>用于计算引用数据</p>
     * @see TemplatePlaceholderPattern#AGGREGATE_REFERENCE_TEMPLATE_PLACEHOLDER
     */
